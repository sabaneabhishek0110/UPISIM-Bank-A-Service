package com.example.hdfc.filter;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    public JwtAuthFilter(HdfcService hdfcService) {
    ...
    protected void doFilterInternal(
        ...
        if (path.startsWith("/internal/hdfc/npci/register-public-key") ||
        ...
        if(!valid){
            System.out.println("request rejected by hdfc bank");
            response.setStatus(HttpServletResponse.SC_UNAUTHORIZED);
            return;
        }
